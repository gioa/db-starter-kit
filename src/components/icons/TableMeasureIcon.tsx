...
<path d="M5 11V14.25C5 14.6642 5.33579 15 5.75 15H15.25C15.6642 15 16 14.6642 16 14.25V11H14.5V13.5H13.625V12H12.125V13.5H11.25V11H9.75V13.5H8.875V12H7.375V13.5H6.5V11H5Z" fill="currentColor"/>
</svg>
  )
);
