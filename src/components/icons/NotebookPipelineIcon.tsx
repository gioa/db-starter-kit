...
export const NotebookPipelineIcon = forwardRef<SVGSVGElement, NotebookPipelineIconProps>(
  ({ size = 16, className, ariaLabel, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
<path fillRule="evenodd" clipRule="evenodd" d="M3 1.75C3 1.33579 3.33579 1 3.75 1H14.25C14.6642 1 15 1.33579 15 1.75V8H13.5V2.5H7.5V13.5H9.5V15H3.75C3.33579 15 3 14.6642 3 14.25V12.5H1V11H3V8.75H1V7.25H3V5H1V3.5H3V1.75ZM4.5 2.5V13.5H6V2.5H4.5Z" fill="currentColor"/>
