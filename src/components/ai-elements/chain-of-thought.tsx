...
import { CheckCircle2Icon, ChevronDownIcon, DotIcon } from "lucide-react";
...
> & {
  /** Show a spinning loader instead of checkmark (i.e. still processing) */
  isStreaming?: boolean;
};
  ...
  ({ className, children, isStreaming = false, ...props }: ChainOfThoughtHeaderProps) => {
    ...
    return (
      <Collapsible onOpenChange={setIsOpen} open={isOpen}>
        ...
        >
          {isStreaming ? (
            <Spinner size="small" inheritColor className="text-current" />
          ) : (
